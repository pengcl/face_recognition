...
@Component({
  selector: 'app-alarm-database',
  templateUrl: './database.component.html',
})
export class AlarmDatabaseComponent implements OnInit {
  ...
  private getData() {
    this.alarmSvc.targetTypes().subscribe(res => {
      const dbs = [
        {
          id: 1,
          parent_id: null,
      ...
      this.dbs = this.arrSrv.arrToTreeNode(dbs, {
        titleMapName: 'text',
        cb: (item, parent, deep) => {
